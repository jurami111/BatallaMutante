...
public class SwordStrike implements IPower { // Clase que representa el ataque de golpe de espada
    private int damage;
    private int level;
    private int energyCost;

    public SwordStrike(int damage, int level, int energyCost) { // Constructor que inicializa el ataque con el daño, nivel y costo de energía especificados
        this.damage = damage;
        this.level = level;

...
public class FlameThrower implements IPower { // Clase que representa el ataque de lanzallamas
    private int damage;
    private int level;
    private int energyCost;

    public FlameThrower(int damage, int level, int energyCost) { // Constructor que inicializa el ataque con el daño, nivel y costo de energía especificados
        this.damage = damage;
        this.level = level;
